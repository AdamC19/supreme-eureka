...
$(OBJ_DAY6) $(OBJ_DAY7) $(OBJ_DAY8)
CLEAN_LIST=$(TARGET_DAY1) $(TARGET_DAY2) $(TARGET_DAY3) $(TARGET_DAY4) $(TARGET_DAY5) \
 $(TARGET_DAY6) $(TARGET_DAY7) $(TARGET_DAY8) $(DISTCLEAN_LIST)
...
makedir:
	...
	$(BUILD_PATH_DAY6) $(BUILD_PATH_DAY7) $(BUILD_PATH_DAY8) 

.PHONY: all
all: $(TARGET_DAY1) $(TARGET_DAY2) $(TARGET_DAY3) $(TARGET_DAY4) $(TARGET_DAY5) \
 $(TARGET_DAY6) $(TARGET_DAY7) $(TARGET_DAY8)
